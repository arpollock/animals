...
def maxent_irl(feat_map, P_a, gamma, trajs, lr, n_iters, error=0.01):
  """
  ...
  for iteration in range(n_iters):
    ...
    _, policy = value_iteration.value_iteration(P_a, rewards, gamma,
                                                error=error, deterministic=False)
